...
const clips=[
    ...
    },
    {
        ...
        snippet:'문의사항 : 270-2353(취업지원부) 대상자 외 신청이 불가합니다. 전북테크노파크는 11월8일(금)까지만 신청가능',
        clipImage: null
    },
    {
        id:3,
    ...
    render(){
        return(
            <div className="clipGroup">
                {clips.map( clip => {
                    return <Clip order={clip.order} title={clip.title} link={clip.link} snippet={clip.snippet} clipImage={clip.clipImage}/>
                })}
            </div>
        );
    }
